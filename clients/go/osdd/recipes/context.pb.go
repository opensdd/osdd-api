...
func (x *GitHistorySource) GetSkipCommits() bool {
	if x != nil {
		return x.xxx_hidden_SkipCommits
	}
	return false
}

func (x *GitHistorySource) GetSkipPrs() bool {
	if x != nil {
		return x.xxx_hidden_SkipPrs
	}
	return false
}
